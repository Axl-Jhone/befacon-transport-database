<nav id="sidebar" class="sidebar">
    <ul>
        ...
        <li class="<?php echo ($page_key == 'drivers') ? 'active' : ''; ?>">
            <a href="home.php?page=drivers" class="menu-item">
        ...
        <li class="<?php echo ($page_key == 'vehicles') ? 'active' : ''; ?>">
            <a href="home.php?page=vehicles" class="menu-item">
